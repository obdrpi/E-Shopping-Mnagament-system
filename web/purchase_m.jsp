...
<html>
    ...
    comp = request.getParameterValues("mobile");
int i,j=0;
if(comp!= null)
...
String query = "select PRICE from mobile where COMPANY= '"+company[i]+"' and MODEL_NO ='"+model[i].trim()+"'";
rs3= stmnt.executeQuery(query);
if(rs3.next()==true)
tot=tot+Integer.parseInt(rs3.getString(1));

session.setAttribute("product","mob");
