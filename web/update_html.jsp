<%-- 
    ...
    Created on : 8 Apr, 2013, 11:29:33 PM
    Author     : dell
--%>
<%-- 
    Document   : regis.jsp
...
<body id="main_body" >
	<div id="form_container">
		...
		<form name="myform" class="appnitro"  action="http://localhost:8080/e_shop/update.jsp">
...
<option value="female" >Female</option>
		...
		<div>
			<input id="element_4" name="element_4"  type="text" maxlength="20" value=""/> 
		</div> 
                </li>
                 <li id="li_10" >
    ...
    * The selected fields are mandatory
